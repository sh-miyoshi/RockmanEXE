...
void Main::StateCharSelect::Draw(){
	...
	DrawCharacter::GetInst()->DrawStringCenter(def::FMX / 2, 20, SELECT_NAMES[select], WHITE);// 敵名描画
	...
	case def::eKIND_フォルテ:
		...
		break;
	case def::eKIND_My情報:
		DrawCharacter::GetInst()->DrawStringCenter(def::FMX / 2, def::FMY / 2 - 40, SELECT_NAMES[def::eKIND_My情報], WHITE);
		break;
	default:
